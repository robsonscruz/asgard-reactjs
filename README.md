...
- [Kubernetes DevSecOps CICD Project Using Github Actions and ArgoCD](#kubernetes-devsecops-cicd-project-using-github-actions-and-argocd)
  - [Video Tutorial.](#video-tutorial)
    ...
    - [Step 1: SSH Exchange between local computer and Github account](#step-1-ssh-exchange-between-local-computer-and-github-account)
      - [Git Clone the application code and IaC repositories](#git-clone-the-application-code-and-iac-repositories)
      - [Connect the repository to your Github](#connect-the-repository-to-your-github)
    - [Step 2: CREATE AWS Resources](#step-2-create-aws-resources)
      - [Create an IAM user and generate the AWS Access key](#create-an-iam-user-and-generate-the-aws-access-key)
      - [Create Github Repo Secret for iac](#create-github-repo-secret-for-iac)
      - [Create S3 Bucket for Terraform State files](#create-s3-bucket-for-terraform-state-files)
      - [Create key pair](#create-key-pair)
    - [Step 3: Install Terraform \& AWS CLI](#step-3-install-terraform--aws-cli)
      - [Terraform Installation Script for WSL](#terraform-installation-script-for-wsl)
      - [AWSCLI Installation Script](#awscli-installation-script)
      - [Terraform and AWSCLI Installation on MacOS](#terraform-and-awscli-installation-on-macos)
      - [Configure AWS CLI](#configure-aws-cli)
    - [Step 4: Deploy the Jumphost Server(EC2) using Terraform on Github Actions](#step-4-deploy-the-jumphost-serverec2-using-terraform-on-github-actions)
    - [Step 5: Configure the Jumphost](#step-5-configure-the-jumphost)
      - [Create an eks cluster using the below commands.](#create-an-eks-cluster-using-the-below-commands)
      - [Configure Load Balancer on the EKS](#configure-load-balancer-on-the-eks)
    ...
    - [Step 7: Configure Sonar Cloud for our app\_code Pipeline](#step-7-configure-sonar-cloud-for-our-app_code-pipeline)
      - [1. Create a SonarCloud Account](#1-create-a-sonarcloud-account)
      - [2. Create a New Public Organization](#2-create-a-new-public-organization)
      - [3. Create a Project](#3-create-a-project)
      - [4. Create a Token](#4-create-a-token)
    - [Step 8: Setup Synk Token for the app code pipeline](#step-8-setup-synk-token-for-the-app-code-pipeline)
      - [1. Sign Up for Snyk](#1-sign-up-for-snyk)
      - [2. Verify Your Email](#2-verify-your-email)
      - [3. Log in to Your Snyk Account](#3-log-in-to-your-snyk-account)
      - [4. Generate a Snyk Token](#4-generate-a-snyk-token)
      - [5. Secure Your Token](#5-secure-your-token)
    ...
    - [Step 13: Creating an A-Record in AWS Route 53 Using ALB DNS](#step-13-creating-an-a-record-in-aws-route-53-using-alb-dns)
      - [1: Open Route 53 Dashboard](#1-open-route-53-dashboard)
      - [2: Select Hosted Zone](#2-select-hosted-zone)
      - [3: Create Record](#3-create-record)
      - [4: Confirm and Create](#4-confirm-and-create)
